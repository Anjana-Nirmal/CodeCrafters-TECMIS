...
public class CAEligibilityIndi {

    static String courseCode;
    static String undergraduate_id;
    static double q1;
    static double q2;
    static double q3;
    ...
    public CAEligibilityIndi(String courseCcode,String undergraduate_id)
    {
        this.courseCode=courseCcode;
